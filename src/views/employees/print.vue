...
<script>
import { userEmployeesInfo as getPersonalDetail,
  getJobInfo as getJobDetail
} from '@/api/employees'
import { getMoreUserInfoById as getUserDetailById } from '@/api/user'
export default {
  data() {
    return {
      formData: {},
      userId: this.$route.params.id,
      type: this.$route.query.type // 打印类型 query传参 ？+type=""
    }
  },
  // 创建完毕状态
  created() {
