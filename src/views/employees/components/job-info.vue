<template>
  <div class="job-info">
    ...
    <el-form label-width="220px">
      ...
      <!-- 从业信息 -->
      <el-form-item>
        <el-button type="primary" @click="saveUpdateJobsInfo">保存更新</el-button>
...
import { getJobInfo, updateJobInfo } from '@/api/employees'
export default {
  data() {
    return {
  ...
  methods: {
    ...
    async saveUpdateJobsInfo() {
      await updateJobInfo(this.formData)
      this.$message.success('岗位信息更改成功')
    }
  }
}
</script>
